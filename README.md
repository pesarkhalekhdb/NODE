# NODE
RUNNING NEW NODE
۱- نیاز به یک والت اتریومم دارید که پرایویسی کی رو کپی کنید و توش هم فاست اتریوم سپولیا داشته باشید  VVGH
...
sh -c "$(curl -sSfL https://release.solana.com/v1.17.9/install)"SH
